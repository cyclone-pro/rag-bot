"""V2 Configuration - Optimized for candidates_v3 - FIXED VERSION."""
import os
...
# ========================
USE_CELERY = os.getenv("USE_CELERY", "false").lower() == "true"  # NEW: Enable/disable Celery

# ========================
# Connection Pool Config
# ========================
# FIXED: Logic was backwards - when env var is "true", enable pooling
